...
\begin{table}[H]
	...
	\begin{adjustbox}{max width=\textheight}
        ...
        Total     \\
				\midrule
				\multicolumn{7}{@{}l}{\textit{Panel A. Overall (all years)}}		\\			
				\primitiveinput{tables/summ_stats_pooled_se.tex} 			
				\midrule						
				\multicolumn{7}{@{}l}{\textit{Panel B. 2005}}			\\			
				\primitiveinput{tables/summ_stats_2005_se.tex}	
				\midrule				
				\multicolumn{7}{@{}l}{\textit{Panel C. 2009}}			\\				
				\primitiveinput{tables/summ_stats_2009_se.tex}				
				\midrule		 				
				\multicolumn{7}{@{}l}{\textit{Panel D. 2014}}			\\	
				\primitiveinput{tables/summ_stats_2014_se.tex} 				
				\bottomrule
			\end{tabular}
			\begin{tablenotes}
				\setlength\labelsep{0pt}
...
\begin{table}[H]
	...
	\begin{adjustbox}{max width=\textheight}
        ...
        Total     \\
				\midrule
        \multicolumn{7}{@{}l}{\textit{Panel A. Women}}		              \\			
				\multicolumn{7}{@{}l}{\textit{Overall (all years)}}		\\			
				\primitiveinput{tables/summ_stats_pooled_se_0.tex} 			
				\multicolumn{7}{@{}l}{\textit{2005}}			\\			
				\primitiveinput{tables/summ_stats_2005_se_0.tex}	
				\multicolumn{7}{@{}l}{\textit{2009}}			\\				
				\primitiveinput{tables/summ_stats_2009_se_0.tex}								
				\multicolumn{7}{@{}l}{\textit{2014}}			\\	
				\primitiveinput{tables/summ_stats_2014_se_0.tex} 			
        \midrule
        \multicolumn{7}{@{}l}{\textit{Panel B. Men}}		              \\			
				\multicolumn{7}{@{}l}{\textit{Overall (all years)}}		\\			
				\primitiveinput{tables/summ_stats_pooled_se_1.tex} 			
				\multicolumn{7}{@{}l}{\textit{2005}}			\\			
				\primitiveinput{tables/summ_stats_2005_se_1.tex}	
				\multicolumn{7}{@{}l}{\textit{2009}}			\\				
				\primitiveinput{tables/summ_stats_2009_se_1.tex}								
				\multicolumn{7}{@{}l}{\textit{2014}}			\\	
				\primitiveinput{tables/summ_stats_2014_se_1.tex} 			
				\bottomrule
			\end{tabular}
			\begin{tablenotes}
				\setlength\labelsep{0pt}
