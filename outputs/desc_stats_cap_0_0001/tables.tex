	...
	\begin{adjustbox}{width=\linewidth}
		\begin{threeparttable}
			...
			\begin{tabular}{@{}l*{6}{c}@{}}
				...
				(6)				\\
				\midrule 
				\multicolumn{6}{@{}l}{\textit{Panel A. Covariates}}						\\			
				\primitiveinput{tables/balance_cov.tex} 			
				\midrule						
				\multicolumn{6}{@{}l}{\textit{Panel B. Pre-intervention outcome}}		\\			
...
\begin{table}[H]
	...
	\begin{adjustbox}{max width=\textheight}
		\begin{threeparttable}
			\caption{Impact of the program on other outcomes}
			\label{tab:other_outcomes_gender}
			\begin{tabular}{@{}l*{4}{c}@{}}
				\toprule
								&
				\multicolumn{4}{c}{Dependent variable:} \\ 
				...
				\midrule 
				\multicolumn{5}{@{}l}{\textit{Panel A. Overall}}							\\	
				\multicolumn{5}{@{}l}{\textbf{1. Primary completed or less}}				\\					
				\primitiveinput{tables/main_did_other_outcomes_primary.tex} 				\\ [-1em]
				\multicolumn{5}{@{}l}{\textbf{2. Secondary completed or less}}				\\					
				\primitiveinput{tables/main_did_other_outcomes_high_school.tex} 			\\ [-1em]
				\multicolumn{5}{@{}l}{\textbf{3. Above secondary school}}					\\					
				\primitiveinput{tables/main_did_other_outcomes_more_hs.tex} 				\\ [-1em]		
				\midrule
				\multicolumn{5}{@{}l}{\textit{Panel B. Females}}							\\ 
				\multicolumn{5}{@{}l}{\textbf{1. Primary completed or less}}				\\					
				\primitiveinput{tables/main_did_other_outcomes_primary_sex_0.tex} 			\\ [-1em]
				\multicolumn{5}{@{}l}{\textbf{2. Secondary completed or less}}				\\					
				\primitiveinput{tables/main_did_other_outcomes_high_school_sex_0.tex} 		\\ [-1em]
				\multicolumn{5}{@{}l}{\textbf{3. Above secondary school}}					\\					
				\primitiveinput{tables/main_did_other_outcomes_more_hs_sex_0.tex} 			\\ [-1em]
				\midrule 
				\multicolumn{5}{@{}l}{\textit{Panel C. Males}}								\\		
				\multicolumn{5}{@{}l}{\textbf{1. Primary completed or less}}				\\					
				\primitiveinput{tables/main_did_other_outcomes_primary_sex_1.tex} 			\\ [-1em]
				\multicolumn{5}{@{}l}{\textbf{2. Secondary completed or less}}				\\					
				\primitiveinput{tables/main_did_other_outcomes_high_school_sex_1.tex} 		\\ [-1em]
				\multicolumn{5}{@{}l}{\textbf{3. Above secondary school}}					\\					
				\primitiveinput{tables/main_did_other_outcomes_more_hs_sex_1.tex} 			\\ [-1em]						
				\midrule			
				Controls						& Yes & Yes	& Yes & Yes \\
				Regional Fixed Effects			& Yes & Yes	& Yes & Yes \\
				Occupation Fixed Effects		& Yes & Yes & Yes &	Yes	\\
