...
\begin{document}
%-----------------------------------------------------------------
\title{Does the Small Business Program Benefit Self-Employed Workers?  Evidence from Nicaragua \\ Caliper 0.00001} 
\author{Booyuel Kim \and Hee-Seung Yang \and Rony Rodriguez-Ramirez}
\maketitle
%-----------------------------------------------------------------
