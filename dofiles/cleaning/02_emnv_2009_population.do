...
*** Generate variables
	...
	/* NOTE: NO INFORMATION FOR INFORMALITY IN EMNV 2009
	Informality 
	...
	*/
	...
	replace working_months= working_months31 if s5p18!=4 & s5p33==4
	replace working_months= working_months46 if s5p18!=4 & s5p47==4
	...
	gen i_occup=occup14
	replace i_occup= occup29 if s5p18!=4 & s5p33==4
	replace i_occup= occup44 if s5p18!=4 & s5p47==4
	...
	*	~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	gen i_income_s_fourth=s5p54b/12 if s5p54a==1
