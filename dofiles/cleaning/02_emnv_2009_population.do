...
*** Generate variables
	...
	replace edu_y=0 if s4p12a==3 |s4p12a==2 | s4p12a==1| s4p12a==0 | s4p12a==12
	...
	replace edu_y=0 if s4p12a==0 | s4p12a==1 
	...
	gen selfemployment_2= (s5p33==4) if s5p33!=.				 	//	Second Activity 
	gen selfemployment_3= (s5p47==4) if s5p47!=.					//	Third  Activity 
	...
	gen employed_2 = (s5p33==1) if s5p33!=.				 			// 	Second Activity
	gen employed_3 = (s5p47==1) if s5p47!=. 						//	Third  Activity 
	...
	tab s4p29 if s4p29==0, gen (training_nocost)
	rename training_nocost1 training_nocost
	replace training_nocost=0 if s4p29!=0 & s4p28==1
	...
	rename working_months31 working_months_2
	rename working_months46 working_months_3
	...
	rename occup29 occup_2
	rename occup44 occup_3
	...
	rename i_net_income_34	i_net_income_2
	rename i_net_income_48	i_net_income_3
	...
	rename i_income_41 i_income_2
	rename i_income_52 i_income_3
